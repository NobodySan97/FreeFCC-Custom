...
| 2026-07-19 | Avata 360 + RC2, FreeFCC 1.5.13 | `wire_exchange` + identity/4G probes | Не найден | reachable | OBSERVED: `40007` same-socket response содержит валидный `03:F8` payload `00a259ceedef`; passive `00:81/82` содержит controller string `rc331`; `device_info` и aircraft serial не ответили; eSIM compatibility не доказана |
