...
| `dji_firmware/V02.02.0803_rm700_dji_system.bin` | 1 469 … (tar) | `a7d15d49d8ebe9968cafa9202d2828a626d0664d2d606dc21de776024b840782` | DJI RC Pro; модуль `0600` (`type=GD32`, `enc_key` пуст) — четвёртая незашифрованная MCU-прошивка пульта; новые команды `06:2D/2E/58/6C/6D/7C/85`, `0D:27`, `19:43`, `01:80` |
...
GD32 Cortex-M, база `0x08000000`, таблица на `0x08028c1c` (34 команды,
rc520-формат). Полный разбор — в [`RM700_RC_PRO_MCU.md`](RM700_RC_PRO_MCU.md).
