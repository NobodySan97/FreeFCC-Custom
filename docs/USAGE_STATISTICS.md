...
`aircraft_serial` хранится в приложении как последнее успешно обнаруженное
значение. Непустое поле подтверждает, что этот дрон был доступен приложению хотя
бы однажды, но не доказывает, что он был включён именно в момент snapshot.
